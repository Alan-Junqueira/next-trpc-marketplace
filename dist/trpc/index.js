...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        query: query_validator_1.queryValidatorSchema,
    }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var _b, sort, limit, queryOpts, cursor, payload, parsedQueryOpts, page, _c, items, hasNextPage, nextPage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _b = input.query, sort = _b.sort, limit = _b.limit, queryOpts = __rest(_b, ["sort", "limit"]), cursor = input.cursor;
