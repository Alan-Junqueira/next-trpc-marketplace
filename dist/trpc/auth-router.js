...
var sign_up_validator_1 = require("../lib/validators/sign-up-validator");
...
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        .input(sign_up_validator_1.authSchema)
    ...
    signIn: trpc_1.publicProcedure.input(sign_up_validator_1.authSchema).mutation(function (_a) {
